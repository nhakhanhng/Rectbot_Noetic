...
class PoseObject {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('detection')) {
        ...
        this.detection = new vision_msgs.msg.Detection2D();
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type PoseObject
    // Serialize message field [detection]
    bufferOffset = vision_msgs.msg.Detection2D.serialize(obj.detection, buffer, bufferOffset);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type PoseObject
    let len;
    let data = new PoseObject(null);
    // Deserialize message field [detection]
    data.detection = vision_msgs.msg.Detection2D.deserialize(buffer, bufferOffset);
  ...
  static getMessageSize(object) {
    let length = 0;
    length += vision_msgs.msg.Detection2D.getMessageSize(object.detection);
    length += 12 * object.keypoints.length;
    return length + 4;
  }

  static datatype() {
    // Returns string type for a message object
    return 'rectbot_cv/PoseObject';
  }

  static md5sum() {
    //Returns md5sum for a message object
    return 'f36e3669b0713547250eac0a5f98a3b6';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new PoseObject(null);
    if (msg.detection !== undefined) {
      resolved.detection = vision_msgs.msg.Detection2D.Resolve(msg.detection)
    }
    else {
      resolved.detection = new vision_msgs.msg.Detection2D()
    }
