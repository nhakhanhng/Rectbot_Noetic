...
if(NOT "/SLAM/rectbot_ws/src/rectbot_bt/include " STREQUAL " ")
  set(rectbot_bt_INCLUDE_DIRS "")
  set(_include_dirs "/SLAM/rectbot_ws/src/rectbot_bt/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rectbot_bt' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/SLAM/rectbot_ws/src/rectbot_bt/${idir}'.  ${_report}")
    endif()
